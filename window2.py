...
def menu():
    ...
    button1=tkinter.Button(root1,text="1.ROOM BOOKING",command=PAT,bg='light blue',fg='black')
    button2 = tkinter.Button(root1, text="2.ROOM AVAILABILITY",bg='light green',fg='black',command=Room_all)
    button3 = tkinter.Button(root1, text="3.CUSTOMER REGISTRATION",bg='light blue',fg='black',command=emp_screen)
    button4 = tkinter.Button(root1, text="4.BOOK ROOM",bg='light green',fg='black',command=appo)
    button5 = tkinter.Button(root1, text="5.CUSTOMER BILL",bg='light blue',fg='black',command=BILLING)
...
def nothing1():
    print("MADE BY Tejas,Kaustubh,Russel")
...
def PAT():
    ...
    id=tkinter.Label(rootp,text="CUSTOMER ID")
    pat_ID=tkinter.Entry(rootp)
    name=tkinter.Label(rootp,text="CUSTOMER NAME")
